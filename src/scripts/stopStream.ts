...
const stopStream = async () => {
    try {
        ...
        let closeStream = CloseStream__factory.connect(
            CloseStreamAddress,
            deployer,
        ) as CloseStream;
        ...
        let execData = closeStream.interface.encodeFunctionData("closeStream", [
            deployer.address,
            receiver,
        ]);
        ...
        console.log("Impersonating the Execution");
        ...
        console.log("retrieving the stream");
